  ...
  switch (node.type) {
    ...
    case "gallery":
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
        ...
        gap: `${props.gap || 16}px`
      }, children: (props.images || []).map((image, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: image.src, alt: image.alt || "", style: { width: "100%", aspectRatio: "1", objectFit: "cover", borderRadius: "12px" } }, image.id || index)) });
    case "video":
