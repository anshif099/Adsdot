...
function InlineText({
  ...
  if (html && !editing) {
    return /* @__PURE__ */ jsx(Tag, { ...common, dangerouslySetInnerHTML: { __html: cleanHtml(display) } });
  }
  return /* @__PURE__ */ jsx(Tag, { ...common, children: display });
}
...
function cards(items, bodyKey = "description") {
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    gap: "22px",
    marginTop: "30px"
  }, children: items.map((item, index) => /* @__PURE__ */ jsxs("article", { style: {
    padding: "24px",
    ...
    item.image || item.avatar ? /* @__PURE__ */ jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsx("h3", { style: { margin: "12px 0 8px", color: "var(--rcms-color-text, #0f172a)", fontSize: "19px" }, children: item.title || item.name || `Item ${index + 1}` }),
    /* @__PURE__ */ jsx("p", { style: { margin: 0, color: "#64748b", lineHeight: 1.7 }, children: item[bodyKey] || item.quote || item.bio || item.excerpt || "" })
  ] }, item.id || index)) });
}
function BuiltinComponent({
  ...
  if (["section", "container", "grid", "flex", "columns"].includes(node.type)) {
    ...
    return /* @__PURE__ */ jsx("div", { style: { ...layout, minHeight: node.children?.length ? void 0 : mode === "edit" ? "90px" : void 0 }, children: node.children?.length ? children : mode === "edit" ? /* @__PURE__ */ jsxs("div", { style: { minHeight: "90px", display: "grid", placeItems: "center", border: "1px dashed #cbd5e1", borderRadius: "10px", color: "#94a3b8", fontSize: "12px" }, children: [
  ...
  switch (node.type) {
    case "hero":
      return /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsx("span", { style: buttonStyle({ ...node, props: { ...props, color: "#2563eb", size: "lg" } }), children: inline("buttonText", "Get Started", "span") })
      ] });
    case "heading": {
    ...
    case "accordion": {
      ...
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { style: { display: "grid", gap: "10px" }, children: items.map((item, index) => /* @__PURE__ */ jsxs("details", { style: { padding: "16px 18px", border: "1px solid #e2e8f0", borderRadius: "12px", background: "#fff" }, children: [
          /* @__PURE__ */ jsx("summary", { style: { cursor: "pointer", fontWeight: 700, color: "#0f172a" }, children: item.question || item.title || `Item ${index + 1}` }),
          /* @__PURE__ */ jsx("p", { style: { color: "#64748b", lineHeight: 1.7 }, children: item.answer || item.content })
        ] }, item.id || index)) })
      ] });
    }
    case "cta":
      return /* @__PURE__ */ jsxs("div", { style: { padding: "56px 32px", borderRadius: "22px", textAlign: "center", color: "#fff", background: props.background || "linear-gradient(135deg,#1d4ed8,#7c3aed)" }, children: [
        ...
        /* @__PURE__ */ jsx("span", { style: buttonStyle({ ...node, props: { color: "#0f172a", size: "lg" } }), children: inline("primaryButtonText", "Get Started", "span") })
      ] });
    case "contact":
      return /* @__PURE__ */ jsxs("div", { style: { maxWidth: "760px", margin: "0 auto" }, children: [
        inline("title", "Contact us", "h2", { color: "#0f172a", fontSize: "38px" }),
        inline("subtitle", "Tell us how we can help.", "p", { color: "#64748b" }),
        /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: "12px", marginTop: "22px" }, children: [
          (props.fields || [{ placeholder: "Your name" }, { placeholder: "Email address" }, { placeholder: "How can we help?" }]).map((field, index) => /* @__PURE__ */ jsx("input", { readOnly: true, placeholder: field.placeholder || field.name, style: { height: "48px", padding: "0 14px", border: "1px solid #cbd5e1", borderRadius: "10px" } }, field.id || index)),
          /* @__PURE__ */ jsx("button", { type: "button", style: { height: "48px", border: 0, borderRadius: "10px", background: "#2563eb", color: "#fff", fontWeight: 700 }, children: text("submitText", "Send Message") })
        ] })
      ] });
    case "newsletter":
      return /* @__PURE__ */ jsxs("div", { style: { padding: "48px 28px", borderRadius: "20px", background: "#0f172a", color: "#fff", textAlign: "center" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", maxWidth: "520px", margin: "24px auto 0", gap: "10px" }, children: [
          /* @__PURE__ */ jsx("input", { readOnly: true, placeholder: text("placeholder", "you@example.com"), style: { flex: 1, height: "48px", borderRadius: "10px", border: "1px solid #334155", background: "#111827", color: "#fff", padding: "0 14px" } }),
          /* @__PURE__ */ jsx("button", { type: "button", style: { padding: "0 20px", border: 0, borderRadius: "10px", background: "#2563eb", color: "#fff", fontWeight: 700 }, children: text("buttonText", "Subscribe") })
        ] })
      ] });
    case "input":
      return /* @__PURE__ */ jsxs("label", { style: { display: "grid", gap: "7px", color: "#334155", fontWeight: 600 }, children: [
        inline("label", "Name", "span"),
        /* @__PURE__ */ jsx("input", { readOnly: true, required: !!props.required, placeholder: text("placeholder", "Enter a value"), style: { height: "46px", padding: "0 13px", border: "1px solid #cbd5e1", borderRadius: "9px", fontSize: "15px" } })
      ] });
    case "textarea-field":
      return /* @__PURE__ */ jsxs("label", { style: { display: "grid", gap: "7px", color: "#334155", fontWeight: 600 }, children: [
        inline("label", "Message", "span"),
        /* @__PURE__ */ jsx("textarea", { readOnly: true, rows: props.rows || 5, placeholder: text("placeholder", "Enter your message"), style: { padding: "12px 13px", border: "1px solid #cbd5e1", borderRadius: "9px", fontSize: "15px", resize: "vertical" } })
      ] });
    case "checkbox":
      return /* @__PURE__ */ jsxs("label", { style: { display: "inline-flex", alignItems: "center", gap: "9px", color: "#334155", fontWeight: 600 }, children: [
        /* @__PURE__ */ jsx("input", { type: "checkbox", readOnly: true, checked: !!props.checked }),
        inline("label", "I agree", "span")
      ] });
    case "select-field":
      return /* @__PURE__ */ jsxs("label", { style: { display: "grid", gap: "7px", color: "#334155", fontWeight: 600 }, children: [
        inline("label", "Choose an option", "span"),
        /* @__PURE__ */ jsx("select", { disabled: true, style: { height: "46px", padding: "0 13px", border: "1px solid #cbd5e1", borderRadius: "9px", background: "#fff" }, children: String(text("options", "First option, Second option")).split(",").map((option) => /* @__PURE__ */ jsx("option", { children: option.trim() }, option.trim())) })
      ] });
    case "slider": {
      const slides = localized(node, locale, "slides", []);
      const slide = slides[0] || {};
      return /* @__PURE__ */ jsxs("div", { style: { minHeight: "340px", padding: "42px", borderRadius: "18px", display: "grid", alignContent: "end", color: "#fff", background: slide.image ? `linear-gradient(transparent,rgba(15,23,42,.8)),url(${slide.image}) center/cover` : "linear-gradient(135deg,#0f172a,#334155)" }, children: [
        /* @__PURE__ */ jsx("h2", { style: { margin: 0, fontSize: "38px" }, children: slide.title || "Slider" }),
        /* @__PURE__ */ jsx("p", { style: { color: "#cbd5e1" }, children: slide.description || "Add slides in the Inspector." })
      ] });
    }
    case "embed":
      return /* @__PURE__ */ jsx("div", { style: { height: `${props.height || 420}px`, border: "1px dashed #94a3b8", borderRadius: "14px", display: "grid", placeItems: "center", textAlign: "center", color: "#64748b", background: "#f8fafc" }, children: /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("strong", { children: text("title", "Embedded content") }),
        /* @__PURE__ */ jsx("div", { style: { marginTop: "6px", fontSize: "12px" }, children: props.url || "Add an embed URL" })
      ] }) });
    case "code":
      return /* @__PURE__ */ jsx("pre", { style: { margin: 0, padding: "22px", overflow: "auto", borderRadius: "12px", background: "#020617", color: "#cbd5e1", fontSize: "13px", lineHeight: 1.7 }, children: /* @__PURE__ */ jsx("code", { children: props.code || "// Add code" }) });
    case "dynamic":
      return /* @__PURE__ */ jsxs("div", { style: { padding: "18px", borderRadius: "10px", background: "#eef2ff", color: "#3730a3" }, children: [
        text("fallback", "Dynamic content"),
        /* @__PURE__ */ jsxs("div", { style: { marginTop: "5px", fontSize: "10px", opacity: 0.65 }, children: [
    ...
    case "map":
      return /* @__PURE__ */ jsx("div", { style: { height: `${props.height || 420}px`, borderRadius: "16px", display: "grid", placeItems: "center", background: "#e2e8f0", color: "#64748b" }, children: text("address", "Add a map address") });
    case "spacer":
      return /* @__PURE__ */ jsx("div", { style: { height: `${props.height || 64}px` } });
    case "divider":
      return /* @__PURE__ */ jsx("hr", { style: { border: 0, borderTop: `1px ${props.style || "solid"} ${props.color || "#cbd5e1"}`, margin: `${props.margin || 24}px 0` } });
    case "html":
      return /* @__PURE__ */ jsx("div", { dangerouslySetInnerHTML: { __html: cleanHtml(props.code) } });
    case "footer":
      return /* @__PURE__ */ jsx("footer", { style: { padding: "32px", borderRadius: "16px", textAlign: "center", background: "#0f172a", color: "#cbd5e1" }, children: inline("copyright", "\xA9 Your Company", "span") });
    case "custom-react":
      return /* @__PURE__ */ jsxs("div", { style: { padding: "28px", border: "1px dashed #94a3b8", borderRadius: "14px", textAlign: "center", background: "#f8fafc", color: "#475569" }, children: [
        /* @__PURE__ */ jsx("strong", { children: props.componentId || "Custom React Component" }),
        /* @__PURE__ */ jsx("div", { style: { fontSize: "12px", marginTop: "6px" }, children: "Registered runtime component slot" })
      ] });
    default:
      return children || /* @__PURE__ */ jsxs("div", { style: { padding: "24px", border: "1px dashed #cbd5e1", borderRadius: "12px", color: "#64748b" }, children: [
        "Configure ",
        node.label || node.type
      ] });
  }
...
function NodeFrame({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        dropPosition && /* @__PURE__ */ jsx("div", { style: {
          position: "absolute",
          zIndex: 1e3,
          pointerEvents: "none",
        ...
        (hovered || selected) && editable && onInsert && /* @__PURE__ */ jsx(Fragment, { children: [
          ["before", { top: "-13px" }],
          ["after", { bottom: "-13px" }]
        ].map(([position, placement]) => /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
        ...
        selected && editable && /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: [
              ...
              ["paste", "Paste"],
              ["delete", "Delete"]
            ].map(([command, label]) => /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
        ...
        /* @__PURE__ */ jsx("div", { style: { width: "100%", maxWidth: `${design.maxWidth || 1120}px`, margin: "0 auto" }, children })
      ]
    }
  );
}
function RenderNode({
  ...
  const childNodes = (node.children || []).map((child) => /* @__PURE__ */ jsx(RenderNode, { node: child, renderer }, child.id));
  ...
  const content = Registered ? createElement(Registered, componentProps) : /* @__PURE__ */ jsx(
    BuiltinComponent,
    {
      node,
      locale,
...
var RuntimeRendererEngine = class {
  renderPage(tree, options = {}) {
    return /* @__PURE__ */ jsx(RuntimeRenderer, { tree, ...options });
  }
